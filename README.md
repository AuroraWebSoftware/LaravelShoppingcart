...
Run the Composer require command from the Terminal:
    ...
    composer require aurorawebsoftware/shoppingcart
...
You definitely should publish the `config` file and take a look at it.
    ...
    php artisan vendor:publish --provider="AuroraWebSoftware\Shoppingcart\ShoppingcartServiceProvider" --tag="config"
...
To make your life easy, the package also includes a ready to use `migration` which you can publish by running:
    ...
    php artisan vendor:publish --provider="AuroraWebSoftware\Shoppingcart\ShoppingcartServiceProvider" --tag="migrations"
...
The calculation logic for the package is implemented and defined in `Calculator` classes. These implement the `AuroraWebSoftware\Shoppingcart\Contracts\Calculator` Contract and and determine how the prices are calculated and rounded. The calculators can be configured in the confugration file. This is the default calculator:
```php
<?php
